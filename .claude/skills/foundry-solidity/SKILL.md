...
Complete guide for building secure, efficient smart contracts with **Foundry** and **Solidity ^0.8.24** (Etherlink-compatible).
...
## Modern Solidity Patterns (^0.8.24)
...
- **Solidity Features**: See `references/solidity-modern.md` for modern features and syntax (note: features above 0.8.24 may not be available on Etherlink)
